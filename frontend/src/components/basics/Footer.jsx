        ...
        <div className="flex flex-col font-extrabold md:flex-row space-y-6 md:space-y-0 md:space-x-16 text-center md:text-left">
          ...
          <div>
            <ul className="space-y-2">
              <li>
                <a
                  href="https://www.linkedin.com/in/aasritha-sure-2b9bb2324"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://github.com/Aasritha-sure"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="no-underline hover:text-custom-pink"
                >
              ...
              <li>
                <a
                  href="https://leetcode.com/u/sure_aasritha/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="no-underline hover:text-custom-pink"
                >
          ...
          <div>
            <ul className="space-y-2">
              <li>
                <a
                  href="https://github.com/Aasritha-sure/DripTrack.git"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="no-underline hover:text-custom-pink"
                >
              ...
              <li>
                <a
                  href="https://drive.google.com/file/d/1Zm5EujSw3bATGIW6xi1ofb7-U3i553PL/view?usp=drive_link"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="no-underline hover:text-custom-pink"
                >
